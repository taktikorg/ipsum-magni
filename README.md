<div align="center">
  ...
  <h1>@taktikorg/ipsum-magni</h1>
  <p>ESLint plugin for Jest</p>
</div>

[![Actions Status](https://github.com/taktikorg/ipsum-magni/actions/workflows/nodejs.yml/badge.svg?branch=main)](https://github.com/taktikorg/ipsum-magni/actions)

## Installation

```bash
yarn add --dev eslint @taktikorg/ipsum-magni
```

**Note:** If you installed ESLint globally then you must also install
`@taktikorg/ipsum-magni` globally.
...
```js
const jest = require('@taktikorg/ipsum-magni');
...
💼
[Configurations](https://github.com/taktikorg/ipsum-magni/blob/main/README.md#shareable-configurations)
enabled in.\
⚠️ [Configurations](https://github.com/taktikorg/ipsum-magni/blob/main/README.md#shareable-configurations)
set to warn in.\
✅ Set in the `recommended`
[configuration](https://github.com/taktikorg/ipsum-magni/blob/main/README.md#shareable-configurations).\
🎨 Set in the `style` [configuration](https://github.com/taktikorg/ipsum-magni/blob/main/README.md#shareable-configurations).\
...
### @taktikorg/ipsum-magni-extended

This is a sister plugin to `@taktikorg/ipsum-magni` that provides support for the
matchers provided by
[`jest-extended`](https://github.com/jest-community/jest-extended).

<https://github.com/taktikorg/ipsum-magni-extended>

### @taktikorg/ipsum-magni-formatting

This project aims to provide formatting rules (auto-fixable where possible) to
ensure consistency and readability in jest test suites.

<https://github.com/dangreenisrael/@taktikorg/ipsum-magni-formatting>
